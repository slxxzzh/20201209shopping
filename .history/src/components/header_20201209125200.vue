      ...
      <div class="Cwrapper">
        <div class="CwrapperContent">
          <van-cell-group title="当前城市">
            <van-cell>
              <span class="citySpan">成都</span>
            </van-cell>
          </van-cell-group>
          <van-cell-group left title="热门城市">
            <van-cell>
              <span class="citySpan">成都</span><span class="citySpan">成都</span><span class="citySpan">成都</span><span class="citySpan">成都</span><span class="citySpan">成都</span><span class="citySpan">成都</span><span class="citySpan">成都</span><span class="citySpan">成都</span><span class="citySpan">成都</span>
            </van-cell>
          </van-cell-group>
          <van-index-bar>

  ...
  <div>
    ...
    <div class="wrapper">
      <div class="wrapperContent">
        ...
        <!-- 一楼 -->
        <floor v-for="item in floorData" :key="item.floor" :shopData="shopData1"></floor>
  ...
  methods: {
    ...
    mapFloorData(floor,floorData){
      Object.keys(floor).map(item=>{
        this.floorData.unshift({"floor":item,"data":floorData.data[item]})
      });
    ...
    this.$api
      ...
      .then((res) => {
        if (res.code === 200) {
          ...
          // this.shopData1 = res.data.floor1

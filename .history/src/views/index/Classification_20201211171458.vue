...
export default {
  ...
  watch: {
    active(v) {
      // 获取展示数据
      // console.log(v);
      this.getClassification(this.allData[this.activeKey].bxMallSubDto[this.active].mallSubId)
      // console.log();
      
      // let o = this.allData.filter(item=>{
      //   // console.log(item);
      //   return parseInt(item.mallCategoryId) === this.activeKey+1
      // })
      // // this.showData = o[0].bxMallSubDto
      // console.log(o[0].bxMallSubDto);

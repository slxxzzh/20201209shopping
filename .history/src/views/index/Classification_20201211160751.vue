    ...
    <div class="wrapperContent">
      ...
      <div class="classification">
        <van-sidebar v-model="activeKey">
          ...
          <van-sidebar-item v-for="item in allData" :key="item.mallCategoryId" :title="item.mallCategoryName" @click="changeTab(item.mallCategoryId)" />
...
export default {
  ...
  methods: {
    changeTab(id){
      console.log(this.allData[0].mallCategoryId);
      console.log(this.allData.filter(item=>{
        return parseInt(item.mallCategoryId) === id
      }));
      // this.tabData = 
    },
    onClickLeft() {

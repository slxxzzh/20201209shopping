...
export default {
  ...
  data() {
    return {
      ...
      bs: null,
      price:0, //商品单价
      testData:this.goodsData||0,
      testData2:this.goodsData?this.goodsData.image_path:"http://images.baixingliangfan.cn/compressedPic/20180413093730_3138.jpg",
      active: 0,
      sku: {
        tree: [{
            v: [{}],
        ...
        price: this.goodsData?this.goodsData.present_price:"555", // 默认价格（单位元）
        stock_num: 227, // 商品总库存
  ...
  mounted() {
    ...
    this.$api
      ...
      .then((res) => {
        ...
        this.price = res.goods.goodsOne.present_price
        console.log(res);
      })
      .catch((err) => {
        console.log(err);
